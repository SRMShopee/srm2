-- Create cities for hub 8ead7d90-3e05-47a3-b76f-67d5e1e74201

-- First, ensure the cities table exists
...
-- Insert cities for the specified hub
...
-- Enable realtime for the cities table
